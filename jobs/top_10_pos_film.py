...
film_sentiment_df = film_sentiment_df.select("title","pos","neg","id")
...
top_10_pos_film = film_sentiment_df.orderBy("pos", ascending=0).limit(10)
top_10_pos_film = top_10_pos_film.select("title","pos")
